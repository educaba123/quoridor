...
# dimensiones de la tabla y barreras
FENCE_SIZE = 8
BASE_LINE_SIZE = 17
FENCE_NUMBER = 15

# definir en valor numero los componentes del juego como barrera, cuadros, etc:
class Item(IntEnum):
    NO_FENCE = 0
    FENCE = 1
    SQUARE = 2
...
# direccion de las barreras aleatorias
class Direction(IntEnum):
    NO = 0
    HORIZONTALLY = 1
    VERTICALLY = 2

# clase para coordenadas de la barrera y direccionamiento
class Fence:
...
# fin crear tabla principal


# condicion si el jugador puede cruzar las barreras
